Todo List is a web application in HTML, CSS, and JavaScript with the ability to display, create, edit, and delete your tasks. This can be used as a to-do list, a shopping list, and much more.
